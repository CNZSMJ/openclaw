...
type CompactionHookRunner = {
  ...
  runBeforeCompaction?: (
    metrics: {
      ...
      compactingMessages?: AgentMessage[];
      messages?: AgentMessage[];
    },
    context: {
      sessionId: string;
...
function buildBeforeCompactionHookMetrics(params: {
  ...
  return {
    originalMessages: structuredClone(params.originalMessages),
    currentMessages: structuredClone(params.currentMessages),
      ...
      await params.hookRunner.runBeforeCompaction?.(
        {
          messageCount: params.metrics.messageCountBefore,
          tokenCount: params.metrics.tokenCountBefore,
          originalMessageCount: params.metrics.messageCountOriginal,
          originalTokenCount: params.metrics.tokenCountOriginal,
          originalMessages: params.metrics.originalMessages,
          compactingMessages: params.metrics.currentMessages,
          messages: params.metrics.currentMessages,
        },
        {
          sessionId: params.sessionId,
