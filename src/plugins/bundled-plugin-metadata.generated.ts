...
export const GENERATED_BUNDLED_PLUGIN_METADATA = [
  ...
  {
    dirName: "context-inspector",
    idHint: "context-inspector",
    source: {
      source: "./index.ts",
      built: "index.js",
    },
    packageName: "@openclaw/context-inspector",
    packageVersion: "2026.3.14",
    packageDescription: "OpenClaw context inspection and optimization plugin",
    packageManifest: {
      extensions: ["./index.ts"],
    },
    manifest: {
      ...
      uiHints: {
        "capture.maxRuns": {
          label: "Max Stored Runs",
          help: "Maximum number of captured runs to retain on disk.",
        },
        "capture.maxStringChars": {
          label: "Max Stored String Chars",
          help: "Soft cap for stored string payloads before truncation markers are added.",
        },
        "security.allowRemoteViewer": {
          label: "Allow Remote Viewer",
          help: "Allow non-loopback access to the browser UI.",
        },
      },
    },
  },
